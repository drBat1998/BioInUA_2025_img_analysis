...
Для запуска графічного інтерфейса виконайте команду ```napari``` в _Unix-терміналі/Anaconda Prompt_ в оточені __bioin-img__.
